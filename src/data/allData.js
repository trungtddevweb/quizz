export const data = {
    ...
    m1: [{
        ...
        listGraft: [
            {
                id: 1.1,
                questionText: "Câu 1. Bản thiết kế sự sống được giấu ở đâu?",
                answers: [
            ...
            {
                id: 2.1,
                questionText: "Câu 2. Đức Chúa Trời đã khóa sự mầu nhiệm bản thiết kế sự sống bằng gì?",
                answers: [
                    { answerText: "A. Lời ví dụ", isCorrect: true },
                    { answerText: "B. Ổ khóa và chìa khóa", isCorrect: false },
            ...
            {
                id: 3.1,
                questionText: "Câu 3. Kinh Thánh dạy dỗ bản chất linh hồn chúng ta đã từng là ai?",
                answers: [
                    { answerText: "A. Chúa tể muôn loài", isCorrect: false },
                    { answerText: "B. Con cái ĐCT", isCorrect: true },
                    { answerText: "C. Tế bào", isCorrect: false },
                    { answerText: "D. Bụi đất", isCorrect: false }
                ],
            },
            {
                id: 4.1,
                questionText: "Câu 4. Quê hương phần linh hồn loài người là đâu?",
                answers: [
                    { answerText: "A. Ê đen", isCorrect: false },
                    { answerText: "B. Trái đất", isCorrect: false },
                    { answerText: "C. Nước Thiên Đàng", isCorrect: true },
                    { answerText: "D. Không có", isCorrect: false }
                ],
            },
            {
                id: 5.1,
                questionText: "Câu 5. Vì sao chúng ta ở trên trái đất này?",
                answers: [
                    { answerText: "A. Vì đầu thai nên ở đây", isCorrect: false },
                    { answerText: "B. Đi trải nghiệm", isCorrect: false },
                    { answerText: "C. Tự nhiên được sinh ra", isCorrect: false },
                    { answerText: "D. Vì phạm tội trên NTĐ", isCorrect: true }
                ],
            },
            {
                id: 6.1,
                questionText: "Câu 6. Hiện tại chúng ta ở trên trái đất này để làm gì?",
                answers: [
                    { answerText: "A. Đi giải hạn", isCorrect: false },
                    { answerText: "B. Chuộc tội lỗi, ăn năn theo tiêu chuẩn của ĐCT", isCorrect: true },
                    { answerText: "C. Không cần làm gì", isCorrect: false },
                    { answerText: "D. Để hưởng thụ", isCorrect: false }
                ],
            },
            {
                id: 7.1,
                questionText: "Câu 7. Điều gì sẽ xảy ra khi chúng ta chết đi",
                answers: [
                    { answerText: "A. Chết là hết", isCorrect: false },
                    { answerText: "B. Trở về Nước Thiên Đàng", isCorrect: false },
                    { answerText: "C. Đứng trước tòa phán xét và bị xét đoán tùy công việc mình làm", isCorrect: true },
                    { answerText: "D. Luân hồi đầu thai", isCorrect: false }
                ],
            },
            {
                id: 8.1,
                questionText: "Câu 8. Sự khác biệt giữa những người đi lên thiên đàng và đi xuống hồ lửa là gì?",
                answers: [
                    { answerText: "A. Khi sống ở đất này làm từ thiện nhiều, sống tốt thì sẽ được đi lên thiên đàng", isCorrect: false },
                    { answerText: "B. Tên được biên vào sách sự sống thì sẽ không phải đi vào hồ lửa", isCorrect: true },
                    { answerText: "C. Người giàu có, quyền lực", isCorrect: false },
                    { answerText: "D. Người đi lễ nhiều", isCorrect: false }
                ],
            },
            {
                id: 9.1,
                questionText: "Câu 9. Chúng ta đã bị đuổi xuống trái đất này, duy nhất ĐCT có thể cứu chúng ta, vậy ngài cứu chúng ta bằng phương pháp nào?",
                answers: [
                    { answerText: "A. Mang đến trái thiện ác", isCorrect: false },
                    { answerText: "B. Sai thiên sứ đến", isCorrect: false },
                    { answerText: "C. Ban sự tha tội bằng LVQ", isCorrect: true },
                    { answerText: "D. Sai bạn tù đến cứu chúng ta", isCorrect: false }
                ],
            },
            {
                id: 10.1,
                questionText: "Câu 10. ĐCT mặc xác thịt đến trái đất này với tư cách là ai?",
                answers: [
                    { answerText: "A. Đức Phật", isCorrect: false },
                    { answerText: "B. Thánh ALLAH", isCorrect: false },
                    { answerText: "C. Đức Chúa Jêsus", isCorrect: true },
                    { answerText: "D. 1 Vị thần khác", isCorrect: false }
                ],
            },
            {
                id: 11.1,
                questionText: "Câu 11. Dấu hiệu nhận biết ĐCT đến lần thứ hai là gì?",
                answers: [
                    { answerText: "A. Là người giàu có, quyền lực, nổi tiếng, tầm tri thức cao", isCorrect: false },
                    { answerText: "B. Là người làm nhiều phép lạ", isCorrect: false },
                    { answerText: "C. Là người làm từ thiện nhiều", isCorrect: false },
                    { answerText: "D. Khôi phục LVQ", isCorrect: true }
                ],
            },
            {
                id: 12.1,
    ...
    m2: [{
        ...
        listGraft: [
            {
                id: 1.21,
                questionText: "Câu 1. Trong quá khứ, loài người không dễ dàng tin những lời tiên tri trong Kinh Thánh, lý do là gì?",
                answers: [
                    { answerText: "A. Vì khoa học chưa phát triển nên những lời trong Kinh Thánh chưa được chứng minh nên nhiều người nhận định Kinh Thánh phi khoa học", isCorrect: false },
                    { answerText: "B. Vì lời Kinh Thánh vượt xa với sự hiểu biết của loài người nên nhiều người nói Kinh Thánh không thực tế", isCorrect: false },
                    { answerText: "C. Cả 2 đáp án trên", isCorrect: true },
                ],
            },
            {
                id: 2.21,
                questionText: "Câu 2. Những dấu chứng để loài người tin vào sự thật là gì?",
                answers: [
                    { answerText: "A. Bằng chứng thông qua truyện tranh", isCorrect: false },
                    { answerText: "B. Bằng chứng thông qua truyền miệng", isCorrect: false },
                    { answerText: "C. Bằng chứng thông qua văn học", isCorrect: false },
                    { answerText: "D. Bằng chứng thông qua lịch sử và khoa học", isCorrect: true }
                ],
            },
            {
                id: 3.21,
                questionText: "Câu 3. Quyển sách nào mô tả chính xác về trái đất đang lơ lửng trong không gian và vòng tuần hoàn của nước trước khi khoa học phát triển?",
                answers: [
                    { answerText: "A. Kinh Phật", isCorrect: false },
                    { answerText: "B. Kinh Dịch", isCorrect: false },
                    { answerText: "C. Kinh Thánh", isCorrect: true },
                    { answerText: "D. Không có quyển sách nào", isCorrect: false }
                ],
            },
            {
                id: 4.21,
                questionText: "Câu 4. Kinh Thánh so với khoa học như thế nào?",
                answers: [
                    { answerText: "A. Đi sau khoa học", isCorrect: false },
                    { answerText: "B. Bằng khoa học", isCorrect: false },
                    { answerText: "C. Đi trước khoa học", isCorrect: true },
                ],
            },
            {
                id: 5.21,
                questionText: "Câu 5. Si-ru vua Phe-rơ-sơ, sau khi chinh phục Babylon đã giải phóng người dân Y-sơ-ra-ên và lập lại đền thờ Giê-ru-sa-lem, lý do là gì?",
                answers: [
                    { answerText: "A. Nhân đạo", isCorrect: false },
                    { answerText: "B. Sở thích cá nhân", isCorrect: false },
                    { answerText: "C. Tin lời tiên tri Kinh Thánh và kính sợ ĐCT", isCorrect: true },
                    { answerText: "D. Muốn được khen ngợi", isCorrect: false }
                ],
            },
            {
                id: 6.21,
                questionText: "Câu 6. Kinh Thánh so với lịch sử như thế nào?",
                answers: [
                    { answerText: "A. Đi sau lịch sử", isCorrect: false },
                    { answerText: "B. Bằng lịch sử", isCorrect: false },
                    { answerText: "C. Đi trước lịch sử", isCorrect: true },
                ],
            },
            {
                id: 7.21,
                questionText: "Câu 7. Kinh Thánh đã chứng minh đúng bao nhiêu %?",
                answers: [
                    { answerText: "A. 25-30%", isCorrect: false },
                    { answerText: "B. 50%", isCorrect: false },
                    { answerText: "C. 70-80%", isCorrect: false },
                    { answerText: "D. 100%", isCorrect: true }
                ],
            },
            {
                id: 8.21,
                questionText: "Câu 8. Kinh Thánh là sự thật, Vậy ĐCT cho chúng ta biết những lời tiên tri sắp tới để làm gì?",
                answers: [
                    { answerText: "A. Để thêm tri thức", isCorrect: false },
                    { answerText: "B. Để biết cho vui", isCorrect: false },
                    { answerText: "C. Để chúng ta tin chắc chắn có NTĐ và có sự chuẩn bị", isCorrect: true },
                    { answerText: "D. Để tham khảo", isCorrect: false }
                ],
            }
        ]
    },
    {
        ...
        listGraft: [
            {
                id: 1.22,
                questionText: "Câu 1. Mục đích lớn nhất mà Đức Chúa Trời ban Kinh Thánh cho chúng ta?",
                answers: [
                    { answerText: "A. Cho chúng ta thêm tri thức", isCorrect: false },
                    { answerText: "B. Dạy dỗ chúng ta đạo đức, văn hóa, hướng con người đến Chân – Thiện – Mỹ", isCorrect: false },
                    { answerText: "C. Làm chứng về Đấng Cứu Chúa đến thế gian cứu rỗi loài người", isCorrect: true },
                    { answerText: "D. Để cho chúng ta nắm chắc kiến thức Lịch sử,khoa học", isCorrect: false }
                ],
            },
            {
                id: 2.22,
                questionText: "Câu 2. Chúng ta muốn biết về ĐCT thì cần thông qua phương tiện nào?",
                answers: [
                    { answerText: "A. Internet", isCorrect: false },
                    { answerText: "B. Sách vở", isCorrect: false },
                    { answerText: "C. Kinh Thánh", isCorrect: true },
                    { answerText: "D. Cha xứ", isCorrect: false },
                    { answerText: "E. Kinh nghiệm người xung quanh", isCorrect: false }
                ],
            },
            {
                id: 3.22,
                questionText: "Câu 3. Tiêu chuẩn nào để các sứ đồ nhận biết ĐC Jêsus là ĐCT?",
                answers: [
                    { answerText: "A. Từ điển thần học", isCorrect: false },
                    { answerText: "B. Kinh Thánh", isCorrect: true },
                    { answerText: "C. Sách tôn giáo", isCorrect: false },
                    { answerText: "D. Hình dáng bên ngoài", isCorrect: false },
                ],
            },
            {
                id: 4.22,
                questionText: "Câu 4. Tại sao những nhà lãnh đạo tôn giáo thời sơ lâm không tin ĐC Jêsus là ĐCT?",
                answers: [
                    { answerText: "A. Vì họ không tin KT", isCorrect: false },
                    { answerText: "B. Vì họ không biết ĐCT chân thật", isCorrect: false },
                    { answerText: "C. Cả 2 lí do trên", isCorrect: true },
                ],
            },
            {
                id: 5.22,
                questionText: "Câu 5. Đức Chúa Trời Toàn Tri Toàn Năng Ngài có thể biến thành hình ảnh giống như loài người không?",
                answers: [
                    { answerText: "A. Không! Không thể, làm sao mà Thần Thánh biến thành người được, tôi không tin điều đó", isCorrect: false },
                    { answerText: "B. Đức Chúa Trời là Đấng sáng tạo muôn vật, Ngài phải luôn ở trên trời", isCorrect: false },
                    { answerText: "C. Vì Đức Chúa Trời là Đấng sáng tạo muôn vật, nên Ngài có thể biến thành bất cứ hình ảnh nào", isCorrect: true },
                    { answerText: "D. Cả A & B", isCorrect: false },
                ],
            },
            {
                id: 6.22,
                questionText: "Câu 6. Chọn “Đúng” với câu trả lời đúng, chọn “Sai” với câu trả lời sai. Đức Chúa Trời Toàn Tri Toàn Năng Ngài có thể biến thành hình ảnh giống như loài người nhiều bao nhiêu cũng được (1 người, 100 người thậm chí là 100 triệu người đều được)",
                answers: [
                    { answerText: "A. Đúng", isCorrect: true },
                    { answerText: "B. Sai", isCorrect: false },
                    { answerText: "C. Đáp án khác", isCorrect: false },
                ],
            },
            {
                id: 7.22,
                questionText: "Câu 7. Lý do gì mà ĐC Jêsus sử dụng duy nhất Kinh Thánh làm chứng về Ngài mà không sử dụng phương pháp khác?",
                answers: [
                    { answerText: "A. Bởi vì chúng ta không có năng lực nhận biết ĐCT", isCorrect: false },
                    { answerText: "B. Để cho chúng ta biết Kinh Thánh là bản thiết kế và ĐCT là tác giả", isCorrect: false },
                    { answerText: "C. Để cho chúng ta dễ dàng làm chứng về Ngài", isCorrect: false },
                    { answerText: "D. Cả 3 đáp án trên đều đúng", isCorrect: true },
                ],
            }
        ]
    },
    {
        ...
        listGraft: [
            {
                id: 1.23,
                questionText: "Câu 1. Trong Kinh Thánh, Đức Chúa Trời đã ví đất nước Y-sơ-ra-ên với loại cây nào?",
                answers: [
                    { answerText: "A. Cây Olive", isCorrect: false },
                    { answerText: "B. Cây sung", isCorrect: false },
                    { answerText: "C. Cây vả", isCorrect: true },
                    { answerText: "D. Cây chà là", isCorrect: false }
                ],
            },
            {
                id: 2.23,
                questionText: "Câu 2. Trong lời tiên tri về cây vả, thời điểm Đức Chúa Jêsus Tái Lâm đã được tiên tri thông qua hình ảnh ví dụ nào?",
                answers: [
                    { answerText: "A. Mùa xuân cây vả có nhành non lá mới đâm", isCorrect: false },
                    { answerText: "B. Mùa hạ cây vả có nhành non lá mới đâm", isCorrect: true },
                    { answerText: "C. Mùa thu cây vả nở hoa bắt đầu kết trái", isCorrect: false },
                    { answerText: "D. Mùa đông cây vả khô héo lụi tàn", isCorrect: false }
                ],
            },
            {
                id: 3.23,
                questionText: "Câu 3. Sự việc Đức Chúa Jêsus rủa sả cây vả không có trái biểu tượng cho điều gì?",
                answers: [
                    { answerText: "A. Đất nước Y-sơ-ra-ên sẽ bị mất mùa", isCorrect: false },
                    { answerText: "B. Đất nước Y-sơ-ra-ên sẽ gặp phải dịch bệnh", isCorrect: false },
                    { answerText: "C. Đất nước Y-sơ-ra-ên sẽ gặp phải khô hạn trong 3 năm", isCorrect: false },
                    { answerText: "D. Đất nước Y-sơ-ra-ên bị diệt vong", isCorrect: true }
                ],
            },
            {
                id: 4.23,
                questionText: "Câu 4. Trong lời ví dụ về cây vả, người đến hái trái vả biểu tượng cho ai? việc hái trái trong 3 năm biểu tượng cho điều gì?",
                answers: [
                    { answerText: "A. Đức Chúa Jêsus, rao truyền Tin Lành Nước Thiên Đàng trong 3 năm", isCorrect: true },
                    { answerText: "B. 1 người nông dân chăm chỉ hái trái vả trong 3 năm", isCorrect: false },
                    { answerText: "C. Đức Giê-hô-va, dẫn dắt người dân Y-sơ-ra-ên trong 3 năm đồng vắng", isCorrect: false },
                    { answerText: "D. Đức Chúa Jêsus, phục sinh sau 3 ngày", isCorrect: false }
                ],
            },
            {
                id: 5.23,
                questionText: "Câu 5. Trong Kinh Thánh, lời rằng \"xin để lại năm nầy nữa\" có nghĩa là gì?",
                answers: [
                    { answerText: "A. Người trồng nho quyết định không chặt cây vả nữa", isCorrect: false },
                    { answerText: "B. Đức Chúa Trời sẽ lập tức phán xét dân Y-sơ-ra-ên sau khi Ngài thăng Thiên vì họ không tiếp nhận Tin Lành", isCorrect: false },
                    { answerText: "C. Đức Chúa Trời sẽ trì hoãn sự phán xét dân tộc Y-sơ-ra-ên cho đến khi Ngài tái lâm", isCorrect: true },
                    { answerText: "D. Đức Chúa Trời không lập tức phán xét dân Y-sơ-ra-ên sau sự kiện thập tự giá mà sẽ chờ đợi cho họ thêm thời gian để tiếp nhận Tin Lành của Đấng Christ", isCorrect: true }
                ],
            },
            {
                id: 6.23,
                questionText: "Câu 6. Chúng ta nhận thấy,, những người chạy trốn từ thành Giê-ru-sa-lem sang thành Phela là những người như thế nào?",
                answers: [
                    { answerText: "A. Ham sống sợ chết", isCorrect: false },
                    { answerText: "B. Là những người tin chắc chắn vào lời tiên tri của Đức Chúa Trời và làm theo", isCorrect: true },
                    { answerText: "C. Là những người không biết lời tiên tri của Đức Chúa Trời", isCorrect: false },
                    { answerText: "D. Là những người coi khinh lời tiên tri của Đức Chúa Trời", isCorrect: false }
                ],
            },
            {
                id: 7.23,
                questionText: "Câu 7. Kết quả nào dành cho những người vẫn ở lại thành Giê-ru-sa-lem?",
                answers: [
                    { answerText: "A. Bị giết bởi lưỡi gươm", isCorrect: false },
                    { answerText: "B. Bị đem đi làm phu tù", isCorrect: false },
                    { answerText: "C. Một số người mẹ ăn thịt con cái mình", isCorrect: false },
                    { answerText: "D. Tất cả các đáp án trên đều đúng", isCorrect: true }
                ],
            },
            {
                id: 8.23,
                questionText: "Câu 8. Theo bạn, lí do thực sự đằng sau sự diệt vong của đất nước Y-sơ-ra-ên năm 70 SCN là gì?",
                answers: [
                    { answerText: "A. Vì quân đội La Mã quá hùng mạnh", isCorrect: false },
                    { answerText: "B. Vì quân đội Y-sơ-ra-ên quá yếu đuối, không chống lại được La Mã", isCorrect: false },
                    { answerText: "C. Vì họ tin vào Đức Chúa Trời", isCorrect: false },
                    { answerText: "D. Vì họ ngoan cố không tiếp nhận Tin Lành của Đức Chúa Trời và khinh dể các lời tiên tri", isCorrect: true }
                ],
            },
            {
                id: 9.23,
                questionText: "Câu 9. Thông qua sự độc lập của đất nước Y-sơ-ra-ên, Kinh Thánh cho chúng ta biết Đức Chúa Jêsus Tái Lâm bắt đầu làm công việc Tin Lành từ khi nào?",
                answers: [
                    { answerText: "A. 1918", isCorrect: false },
                    { answerText: "B. 1939", isCorrect: false },
                    { answerText: "C. 1945", isCorrect: false },
                    { answerText: "D. 1948", isCorrect: true }
                ],
            },
            {
                id: 10.23,
                questionText: "Câu 10. Hình ảnh \"Ngài đương ở trước cửa\" nói lên điều gì?",
                answers: [
                    { answerText: "A. Đức Chúa Jêsus Tái Lâm sắp đến", isCorrect: false },
                    { answerText: "B. Đức Chúa Jêsus Tái Lâm chưa đến", isCorrect: false },
                    { answerText: "C. Đức Chúa Jêsus Tái Lâm không đến", isCorrect: false },
                    { answerText: "D. Đức Chúa Jêsus Tái Lâm đã đến", isCorrect: true }
                ],
            },
            {
                id: 11.23,
                questionText: "Câu 11. Kinh Thánh tiên tri rằng khi nhận biết về thời kỳ Đức Chúa Jêsus Tái Lâm đến thì chúng ta cần mang lấy tấm lòng như thế nào?",
                answers: [
                    { answerText: "A. Nhanh chóng mở cửa tấm lòng và tiếp nhận Ngài, đi theo Ngài", isCorrect: true },
                    { answerText: "B. Từ chối Ngài", isCorrect: false },
                    { answerText: "C. Xem xét việc Đức Chúa Trời Tái Lâm có liên quan đến tôi không", isCorrect: false },
                    { answerText: "D. Tất cả các đáp án đều sai", isCorrect: false }
                ],
            }
        ]
    }, {
        ...
        listGraft: [
            {
                id: 1.24,
                questionText: "Câu 1. Kinh Thánh tiên tri ĐC Jêsus đến 2000 năm trước tại đâu?",
                answers: [
                    { answerText: "A. Bét-le-hem", isCorrect: true },
                    { answerText: "B. Ga-li-lê", isCorrect: false },
                    { answerText: "C. Ê-díp-tô", isCorrect: false },
                    { answerText: "D. Việt Nam", isCorrect: false }
                ],
            },
            {
                id: 2.24,
                questionText: "Câu 2. Để cứu rỗi người dân ở thời đại cuối cùng thì ĐC Jêsus Tái Lâm sẽ phải đến nơi như thế nào?",
                answers: [
                    { answerText: "A. Nơi mà ĐC Jêsus sơ lâm đã đến", isCorrect: false },
                    { answerText: "B. Nơi mà có người dân của ĐCT đang chờ", isCorrect: false },
                    { answerText: "C. Nơi bắt đầu sự cứu rỗi cuối cùng", isCorrect: true },
                    { answerText: "D. Nơi sẽ nhận được nhiều lời sự tán dương và ca ngợi của người dân", isCorrect: false }
                ],
            },
            {
                id: 3.24,
                questionText: "Câu 3. Kinh Thánh tiên tri dấu hiệu về Mặt Trời , Mặt Trăng và các Ngôi Sao cho biết về điều gì sắp xảy đến?",
                answers: [
                    { answerText: "A. Sóng thần sắp xảy ra", isCorrect: false },
                    { answerText: "B. Động đất sắp xảy ra", isCorrect: false },
                    { answerText: "C. Chiến Tranh sắp xảy ra", isCorrect: false },
                    { answerText: "D. ĐC Jêsus Tái Lâm đến", isCorrect: true }
                ],
            },
            {
                id: 4.24,
                ...
                answers: [
                    { answerText: "A. Nơi mà ĐC Jêsus sơ lâm đã đến", isCorrect: false },
                    { answerText: "B. Nơi mà có người dân của ĐCT đang chờ", isCorrect: true },
                    { answerText: "C. Nơi bắt đầu sự cứu rỗi cuối cùng", isCorrect: false },
                    { answerText: "D. Nơi sẽ nhận được nhiều lời sự tán dương và ca ngợi của người dân", isCorrect: false }
                ],
            },
            {
                id: 5.24,
                questionText: "Câu 5. Trong lời tiên tri Kinh Thánh, sau khi thiên sứ đứng ở 4 góc đất cầm 4 hướng gió lại, thì đã có 1 vị thiên sứ khác xuất hiện, vị thiên sứ này là ai?. Và xuất hiện tại đâu?",
                answers: [
                    { answerText: "A. Đức Phật. Tại Phương Nam", isCorrect: false },
                    { answerText: "B. Giáo hoàng. Phương Tây", isCorrect: false },
                    { answerText: "C. Đức Chúa Trời . Phương Đông mặt trời mọc", isCorrect: true },
                    { answerText: "D. Đức Mẹ Maria. Phương Bắc", isCorrect: false }
                ],
            },
            {
                id: 6.24,
                questionText: "Câu 6. Đức Chúa Trời biểu hiện hình ảnh chim ó nói lên điều gì?",
                answers: [
                    { answerText: "A. Biểu tượng cho quyền lực", isCorrect: false },
                    { answerText: "B. Sự cứu rỗi diễn ra nhanh chóng", isCorrect: true },
                    { answerText: "C. Biểu tượng cho sức mạnh", isCorrect: false },
                    { answerText: "D. Không biểu tượng cho điều gì cả", isCorrect: false }
                ],
            },
            {
                id: 7.24,
                questionText: "Câu 7. Kinh Thánh tiên tri rằng Đấng dấy lên từ phương Đông có năng lực khiến sông chảy ra trên đỉnh núi trọi, suối trào lên giữa trũng,sa mạc thành ao và đất khô thành nguồn nước. Hình ảnh này mang ý nghĩa biểu tượng cho điều gì?",
                answers: [
                    { answerText: "A. Loài người sẽ làm ra nước nhân tạo để giải quyết vấn đề nước sạch của trái đất", isCorrect: false },
                    { answerText: "B. Đức Chúa Trời - là nguồn nước sự sống sẽ ban phát nước sự sống phần linh hồn cho toàn bộ thế gian", isCorrect: true },
                    { answerText: "C. Không mang ý nghĩa gi cả", isCorrect: false },
                    { answerText: "D. Tất cả các đáp án trên đều sai", isCorrect: false }
                ],
            },
            {
                id: 8.24,
                questionText: "Câu 8. Ấn của Đức Chúa Trời là gì?",
                answers: [
                    { answerText: "A. Ngày chủ nhật", isCorrect: false },
                    { answerText: "B. Lễ Nô-ên", isCorrect: false },
                    { answerText: "C. Lễ phục sinh", isCorrect: false },
                    { answerText: "D. Lễ Vượt Qua", isCorrect: true }
                ],
            },
            {
                id: 9.24,
                questionText: "Câu 9. Vậy theo tất cả mọi lời tiên tri trong Kinh Thánh thì đất nước mà Đức Chúa Trời lựa chọn khi Ngài Tái Lâm đến thế gian để tiến hành công việc cứu rỗi cuối cùng là nơi nào?",
                answers: [
                    { answerText: "A. Việt Nam", isCorrect: false },
                    { answerText: "B. Trung Quốc", isCorrect: false },
                    { answerText: "C. Nhật Bản", isCorrect: false },
                    { answerText: "D. Hàn Quốc", isCorrect: true }
                ],
            },
            {
                id: 10.24,
                questionText: "Câu 10. Vậy nơi Đức Chúa Jêsus sẽ Tái Lâm đến thế gian là nơi có hội tụ đủ các điều kiện như thế nào?",
                answers: [
                    { answerText: "A. Phía mặt trời mọc tính từ đảo Bát-mô", isCorrect: false },
                    { answerText: "B. Phương Đông tính từ đất nước Y-sơ-ra-ên", isCorrect: false },
                    { answerText: "C. Là nơi đầu tiên trên trái đất giữ gìn Lễ Vượt Qua sau 1600 năm bị xóa bỏ", isCorrect: false },
                    { answerText: "D. Tất cả các đáp án trên đều đúng", isCorrect: true }
                ],
            }
        ]
...
export const tilteListQuestions = [
    "Mảnh 1", "Mảnh 2", "Mảnh 3", "Mảnh 4", "Mảnh 5", "Mảnh 6", "Mảnh 7"
]

export const shortTitleListQuestions = [
